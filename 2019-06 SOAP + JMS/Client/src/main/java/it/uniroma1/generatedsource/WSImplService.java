 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://soapserver.uniroma1.it/", wsdlLocation = "http://localhost:8080/ProfessorManagement//WSInterface?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://soapserver.uniroma1.it/", "WSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ProfessorManagement//WSInterface?wsdl");
    ...
    public WSInterface getWSImplPort() {
        return super.getPort(new QName("http://soapserver.uniroma1.it/", "WSImplPort"), WSInterface.class);
    }
    ...
    public WSInterface getWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapserver.uniroma1.it/", "WSImplPort"), WSInterface.class, features);
    }
