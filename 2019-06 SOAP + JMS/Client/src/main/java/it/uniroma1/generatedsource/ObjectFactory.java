...
public class ObjectFactory {
    ...
    private final static QName _Professor_QNAME = new QName("http://soapserver.uniroma1.it/", "Professor");
    private final static QName _GetDetails_QNAME = new QName("http://soapserver.uniroma1.it/", "getDetails");
    private final static QName _GetDetailsResponse_QNAME = new QName("http://soapserver.uniroma1.it/", "getDetailsResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://soapserver.uniroma1.it/", name = "Professor")
     ...
     */
    @XmlElementDecl(namespace = "http://soapserver.uniroma1.it/", name = "getDetails")
     ...
     */
    @XmlElementDecl(namespace = "http://soapserver.uniroma1.it/", name = "getDetailsResponse")
