 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://uniroma1.it/", wsdlLocation = "http://localhost:7070/WSInterface?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://uniroma1.it/", "WSImplService");
    ...
    public WSInterface getWSImplPort() {
        return super.getPort(new QName("http://uniroma1.it/", "WSImplPort"), WSInterface.class);
    }
    ...
    public WSInterface getWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://uniroma1.it/", "WSImplPort"), WSInterface.class, features);
    }
