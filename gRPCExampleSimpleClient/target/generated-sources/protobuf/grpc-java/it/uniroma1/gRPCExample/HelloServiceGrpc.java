...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "it.uniroma1.gRPCExample.HelloService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<it.uniroma1.gRPCExample.HelloRequest,
      it.uniroma1.gRPCExample.HelloResponse> METHOD_HELLO =
      io.grpc.MethodDescriptor.<it.uniroma1.gRPCExample.HelloRequest, it.uniroma1.gRPCExample.HelloResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "it.uniroma1.gRPCExample.HelloService", "hello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              it.uniroma1.gRPCExample.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              it.uniroma1.gRPCExample.HelloResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(it.uniroma1.gRPCExample.HelloRequest request,
        io.grpc.stub.StreamObserver<it.uniroma1.gRPCExample.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                it.uniroma1.gRPCExample.HelloRequest,
                it.uniroma1.gRPCExample.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public it.uniroma1.gRPCExample.HelloResponse hello(it.uniroma1.gRPCExample.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<it.uniroma1.gRPCExample.HelloResponse> hello(
        it.uniroma1.gRPCExample.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((it.uniroma1.gRPCExample.HelloRequest) request,
              (io.grpc.stub.StreamObserver<it.uniroma1.gRPCExample.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static final class HelloServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return it.uniroma1.gRPCExample.HelloServiceOuterClass.getDescriptor();
    }
  }
